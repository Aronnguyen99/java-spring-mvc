                                ...
                                <div class="row g-4">
                                    <div class="col-lg-6">
                                        <div class="border rounded">
                                            <a href="#">
                                                <img src="/img/imgProduct/${product.image}" class="img-fluid rounded"
                                                    alt="Image">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <ul class="list-unstyled fruite-categorie">
                                                <c:forEach var="listPro" items="${listProducts}">
                                                    <li>
                                                        <div class="d-flex justify-content-between fruite-name">
                                                            <a href="#"><i
                                                                    class="fas fa-apple-alt me-2"></i>${listPro.factory}</a>
                                                            <span>${listPro.quantity}</span>
                                                        </div>
                                                    </li>
                                                </c:forEach>
